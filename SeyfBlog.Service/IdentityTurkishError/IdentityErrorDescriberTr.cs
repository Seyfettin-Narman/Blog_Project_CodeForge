...
namespace SeyfBlog.Service.IdentityTurkishError
{
    public class IdentityErrorDescriberTr : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = "DuplicateUserName", Description = $"Bu username {userName} adresine ait bir hesap zaten var." };
        }
        public override IdentityError DuplicateRoleName(string role)
        {
            return new IdentityError { Code = "DublicateRoleName", Description = $"Bu role {role} ismi zaten mevcut." };
        }
        ...
        {
            return new IdentityError { Code = "InvalidRoleName", Description = $"Belirtilen role {role} ismi geçersizdir." };
        }
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError { Code = "InvalidUserName", Description = $"Belirtilen username {userName} adresi geçersizdir." };
        }
